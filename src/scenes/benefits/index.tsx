...
const benefits: Array<BenefitType> = [
  {
    ...
    description: "Neque adipiscing amet amet enim.Neque adipiscing amet amet enim.Neque adipiscing amet amet enim.Neque adipiscing amet amet enim."
  },
  {
    icon: <UserGroupIcon className="h-6 w-6"/>,
    title: "Hndreds of Diverse classes",
    description: "Neque adipiscing amet amet enim.Neque adipiscing amet amet enim.Neque adipiscing amet amet enim.Neque adipiscing amet amet enim."
  },
  {
  ...
  return (
    <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
      <motion.div
        ...
        <div className='mt-16 items-center justify-between ga-20 md:mt md:flex'>
          {/* GRAPHIC */}
          <img
            className='mx-auto'
